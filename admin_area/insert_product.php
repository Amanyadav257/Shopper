<?php
    ...
    if(isset($_POST['insert_product'])){
        ...
        // accessing images
        $product_image1=$_FILES['product_image1']['name'];//access name attribute
        ...
        or $product_image1=='' or $product_image2=='' or $product_image3==''){
            ...
            //insert product
            $insert_products="insert into `products` (product_title,product_description,product_keywords,category_id,brand_id,product_image1,
            product_image2,
            product_image3,product_price,date,status) values('$product_title','$description','$product_Keywords','$product_categories',
...
<body class="bg-light">
    <div class="container mt-3">
        ...
        <!-------------------------------------------------------------- Form ----------------------------------------------------------->
        <!-- post for sending the data // multipart/form-data for images Insert -->
        ...
        <!-------------------------------------------------------------- title ----------------------------------------------------------->
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" placeholder="Enter Product description" name="description" id="description" class="form-control" autocomplete="off"
                required="required">
            </div>
         ...
         ?>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" placeholder="Enter Product price" name="product_price" id="product_price" class="form-control" autocomplete="off"
                required="required">
            </div>
